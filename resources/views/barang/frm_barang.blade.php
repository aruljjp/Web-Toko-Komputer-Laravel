  ...
  <table class="table table-bordered border-dark">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{$table->diskon}}%</td>
        <td><span class="badge bg-success">{{$table->stok}}</span></td>
        <td><img style="width: 100px" src="{{asset('/images/'.$table->foto)}}"></td>
        <td>
          <a href="{{ url('barang/edit_barang/'.$table->id.'') }}"><span class="badge bg-success"><i class="fas fa-pencil-alt"></i></span></a>
          <a href="{{ url('barang/hapus/'.$table->id.'') }}"><span class="badge bg-danger"><i class="fas fa-trash"></i></span></a>
        </td>
      </tr>
      @endforeach
    </tbody>
